...
window.SITE_DATA = {
    "copy": {
      ...
      "home.subtitle": {
        "zh": "十三年全域设计经验，横跨数字界面、品牌平面与原创 IP 三大板块——从心理测评报告与信息设计、品牌 VI 全案，到画册出版、包装与空间视觉。累计完成数十个从概念到落地的完整案例，覆盖 B/C 端产品、政企品牌与文旅公益等多领域。我以系统化方法、独立落地能力与持续迭代的设计思维，为产品与品牌创造既专业、又实用、且有创意的视觉价值。",
        "es": "Trece años de diseño integral en tres campos — interfaces digitales, diseño de marca e IP original. Desde informes de evaluación psicológica y diseño de información, programas de identidad de marca y edición, hasta packaging y gráfica espacial. Decenas de casos de principio a fin en productos B2B/B2C, marcas corporativas y del sector público, y proyectos culturales o sin ánimo de lucro. Aporto un valor visual profesional, práctico y original mediante un método sistemático, entrega independiente y una mentalidad de mejora constante.",
        "en": "Thirteen years of holistic design across three fields — digital interfaces, brand design and original IP. From psychological-assessment reports and information design, brand VI programmes and editorial publishing to packaging and spatial graphics. Dozens of end-to-end cases spanning B2B/B2C products, corporate and public-sector brands, and cultural or non-profit work. I create professional, practical and original visual value through a systematic method, independent delivery and a mindset of constant iteration."
      },
      "home.cta.works": {
        "zh": "浏览全部作品",
